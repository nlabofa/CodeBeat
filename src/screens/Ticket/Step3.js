...
class Step3 extends Component {
      ...
      <View style={{ marginVertical: RFValue(20) }}>
        ...
        <View style={styles.summarydiv}>
          ...
          >
            {" "}
            {"\u20A6"}
            {this.formatAmount(totalticketconcessionprice + totalticketprice)}
          </Text>
        </View>
      </View>
    );
  ...
  itemBottom = () => {
    const { totalticketprice, totalticketconcessionprice } = this.props;
    return (
      <View>
        <Image
  ...
  voucherInput = () => (
    <View style={styles.voucherinput}>
      ...
      >
        ...
        >
          <Text style={[BaseTheme.buttontext, { color: "#fff" }]}>APPLY</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
      ...
      >
        <View style={{ marginHorizontal: RFValue(20) }}>
          <View style={{ marginTop: RFValue(30) }}>
            <View>
              <Text style={[styles.adtext, { color: "#7d7d89" }]}>STEP 3</Text>
              ...
              <View>
                <Text style={styles.adtext8}>
                  For PG, 15 and 18 certificate films, and some concessions, we
                  may ask you for photographic ID.
                </Text>
              </View>
            </View>
          </View>
