...
class LandingPage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.formatRange();
    this.fetchLocalState();
    this.props.fetchCinemaState();
  ...
  fetchLocalState = async () => {
    try {
      const value = await AsyncStorage.getItem("userdata");
      const token = await AsyncStorage.getItem("usertoken");
      if (value !== null) {
        console.log(JSON.parse(value));
        this.props.saveUserData(JSON.parse(value));
        ...
        >
          ...
          <View>
            <Carousel
              ...
              data={heroebanner_films && heroebanner_films}
            ...
            <Pagination
              ref={c => (this._sliderBRef = c)}
              dotsLength={heroebanner_films && heroebanner_films.length}
          ...
          <View style={{ marginTop: RFValue(20) }}>
            <View style={BaseTheme.carouselhead}>
              ...
              <TouchableOpacity
                style={styles.carouselhead}
                onPress={() => this.navigateTo("MovieListing", "New On VOD")}
              >
...
const mapDispatchToProps = dispatch => {
  return {
    formatRange: () => dispatch(actions.formatRange()),
    fetchLandingFilms: () => dispatch(actions.fetchLandingFilms()),
    fetchCinemaState: () => dispatch(actions.fetchCinemaState()),
    saveUserData: data => dispatch(actions.saveUserData(data)),
    saveUserToken: data => dispatch(actions.saveUserToken(data)),
